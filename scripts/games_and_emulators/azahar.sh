...
Raspbian | Debian | Ubuntu)
  ...
  *)
  ...
  sudo apt-get install git libsdl2-2.0-0 libsdl2-dev qt6-base-dev qt6-base-private-dev libqt6opengl6-dev qt6-multimedia-dev libqt6multimedia6 qt6-tools-dev qt6-l10n-tools linguist-qt6 libfdk-aac-dev build-essential cmake libswscale-dev libavformat-dev libavcodec-dev libavfilter-dev libssl-dev glslang-tools glslang-dev spirv-tools spirv-headers -y || error "Could not install dependencies"
