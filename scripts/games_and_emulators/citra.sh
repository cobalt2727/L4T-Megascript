...
Fedora)
  sudo dnf install -y cmake SDL2-devel openssl-devel libXext-devel qt6-qtbase-devel qt6-qtbase-private-devel qt6-qtmultimedia-devel gcc-c++ glslang-devel  || error "Could not install dependencies!"
  ;;
*)
