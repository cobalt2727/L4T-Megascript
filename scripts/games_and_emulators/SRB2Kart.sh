...
Raspbian | Debian | Ubuntu)
  ...
  ;;
Fedora)
  sudo dnf install -y --refresh wget cmake unzip git SDL2-devel SDL2_mixer-devel libcurl-devel libopenmpt-devel game-music-emu-devel libpng-devel zlib-devel || error "Dependency installs failed"
  ;;
*)
