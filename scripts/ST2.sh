...
sudo apt install build-essential libsdl2-2.0-0 libsdl2-dev libsdl2-image-2.0-0 libsdl2-image-dev curl libcurl4 libcurl4-openssl-dev libvorbis-dev libogg-dev extra-cmake-modules libopenal-dev libglew-dev libboost-dev libboost-all-dev subversion -y
