...
wget https://wdl1.cache.wps.cn/wps/download/ep/Linux2019/10702/wps-office_11.1.0.10702_arm64.deb --progress=bar:force:noscroll || error "Failed to download wps office suite"
